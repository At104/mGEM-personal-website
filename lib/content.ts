...
export const stats = [
  ...
  { value: "10+", numeric: 10, suffix: "+", label: "Years Established", accent: "text-leaf" },
...
export const igemIntro =
  "iGEM is a highly accomplished international synthetic biology competition aimed primarily at undergraduates, with the involvement of graduates, professors, and various stakeholders. Interdisciplinary teams specializing in Wet Lab, Dry Lab, and Human Practices collaborate to create novel synthetic biology oriented projects that can be applied in the real world!";

export const missionIntro =
  "mGEM is McMaster University's award-winning synthetic biology research and design team. Each year, with the involvement of graduates, professors, stakeholders, and the surrounding community, we design and build a synthetic biology project to tackle real-world problems.";
...
export const showcasePhotos = [
  { src: "/WetLab_TeamPhoto.jpg", alt: "Wet Lab team photo in the lab", span: "md:col-span-2 md:row-span-2" },
  { src: "/Westdale_Workshop.jpg", alt: "Outreach workshop at Westdale", span: "" },
  { src: "/HP_Workshop.jpg", alt: "Human Practices workshop", span: "" },
  { src: "/JamboreePhoto.png", alt: "mGEM at the iGEM Grand Jamboree", span: "md:col-span-2" },
] as const;
