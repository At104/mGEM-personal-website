            ...
            <div className = "m-6">
                <div className="min-h-full flex flex-col md:flex-row items-start justify-center m-12 gap-10">
                    <div className="space-y-10 w-full md:w-1/2">
                        ...
                        <p className="max-w-full text-lg py-2 site-page-body">
