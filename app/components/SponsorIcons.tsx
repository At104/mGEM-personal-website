...
export function SponsorIcons() {
  return (
    <>
        <Title text= "mRNA Sponsor" className = "underline underline-offset-2 site-page-heading"/>
        <div className="max-w-7xl mx-auto px-8">
          <HoverEffect items={mRNA} />
        </div>
        <hr/>
        <Title text= "DNA Sponsors" className = "underline underline-offset-2 site-page-heading"/>
        <div className="max-w-7xl mx-auto px-8 mb-10">
          <HoverEffect items={DNA} />
        </div>
        <hr/>
        <Title text= "Promoter Sponsors" className = "underline underline-offset-2 site-page-heading"/>
        <div className="max-w-7xl mx-auto px-8">
