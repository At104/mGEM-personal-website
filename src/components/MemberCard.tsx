...
export default function MemberCard({ member }: { member: Member }) {
  ...
  return (
    <a href={member.link} target="_blank" rel="noopener noreferrer" className="block h-full rounded-3xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-leaf">
      {inner}
    </a>
  );
}
